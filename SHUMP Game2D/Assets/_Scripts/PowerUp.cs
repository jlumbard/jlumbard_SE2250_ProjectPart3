...
public class PowerUp : MonoBehaviour {
	...
	public WeaponType     type;          // The type of the Power
	...
	void Awake() {
		...
		// Random.onSnitSphore gives you a vector point that is somewhere on 
		// the surface of the sphere with a radius of lm around the origin 
		vel.z = 0;       // Flatten the vel to the XY plane
		vel.Normalize(); // Normalizing a Vector3 makes it length Is
